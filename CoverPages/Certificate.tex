...
\end{tikzpicture}
%watermark
%\tikz[remember picture,overlay] \node[opacity=0.5,inner sep=0pt] at (current page.center){\includegraphics[width=0.8\textwidth]{Figures/RV_logoVecW}};
\thispagestyle{empty}
\vspace{-1cm}
\begin{center}
...
%\large
\begin{spacing}{1.5}
\noindent Certified that the \ifMinor{minor project\;}\else{ major\;}\fi project (18MVE41)work titled \textbf{\textit{\printTitle}} is carried out by
\ifPG{%
